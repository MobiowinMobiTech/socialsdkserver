...
public class SocialSdkAccountService implements ISocialSdkService
{
	...
	public Message<String> execute(Message<String> message)
	{
		...
		try
		{
			...
			socialCustId = customerDetailsJson.getString(ApplicationConstants.Keys.CUSTOMER_SOCIAL_ID);

			HashMap<String, Object> custBankDetails = accountDetailService.getCustomerAccountDeatils(socialCustId);

			String response = accountDetailService.generateResponse(custBankDetails);
